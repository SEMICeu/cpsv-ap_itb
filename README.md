# CPSV-AP Validator
**Usage note:**
Please be informed that the CPSV-AP validator is now being redirected to the [SEMIC SHACL Validator](https://www.itb.ec.europa.eu/shacl/semic-shacl/upload). 
The domain-aliases set in place will redirect the current validator ensuring that this change does not affect your existing setups for the CPSV-AP validator.
